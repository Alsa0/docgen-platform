...
import { Wrench, Download, Settings } from 'lucide-react';
  ...
  useEffect(() => {
    const fetchTemplate = async () => {
      try {
        ...
        if (data.templates && data.templates.ir) {
          setTemplate(data.templates.ir);
        }
      } catch (error) {
        console.error("Failed to load IR template", error);
      }
    };
    fetchTemplate();
  }, []);
            ...
            <div className="flex items-center gap-4">
              <label className="checkbox-container">
                ...
                <span style={{ fontWeight: 500, display: 'flex', alignItems: 'center', gap: '6px' }}>
                  ...
                  Rédiger les recommandations et analyses avec l'IA
                </span>
              </label>
            </div>
